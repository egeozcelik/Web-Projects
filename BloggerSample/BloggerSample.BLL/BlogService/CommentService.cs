...
namespace BloggerSample.BLL.BlogService
{
    public class CommentService : ICommentService
    {
        ...
        public List<CommentDTO> getCommentName(string CommentName)
        {
            var getName = uow.GetRepository<Comment>().Get(z => z.Title.Contains(CommentName), null).ToList();
            return MapperFactory.CurrentMapper.Map<List<CommentDTO>>(getName);
        }
